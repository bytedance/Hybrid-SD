...
MODEL_NAME="pretrained_models/SG161222--Realistic_Vision_V5.1_noVAE"
TRAIN_DATA_DIR="datasets/laion_aes/preprocessed_212k"
...
EXP_NAMES=("prune_oneshot/ratio-0.5" "prune_oneshot/ratio-0.75")

for exp_name in ${EXP_NAMES[@]};
do
  echo "exp_name = $exp_name"
  UNET_CONFIG_PATH="results/NaivePrune/bk-sdm-tiny/$exp_name"
