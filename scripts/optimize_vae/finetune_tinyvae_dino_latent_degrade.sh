OUTDIR="/mnt/bn/bytenn-yg2/liuhj/bytenn_diffusion_tools/outputs/latent_degrade"
...
accelerate launch --multi_gpu --num_processes ${NUM_GPUS} --main_process_port 23185\
    /mnt/bn/bytenn-yg2/liuhj/bytenn_diffusion_tools/examples/optimize_vae/finetune_tinyvae_dino_degrade_latent2.py \
    --output_dir $OUTDIR \
    --learning_rate 1e-5 \
    --lr_scheduler "cosine" \
    --lr_warmup_steps 0 \
