...
MODEL_SMALL=tea_realv5.1_tiny_ratio075

PATH_MODEL_LARGE=$MODEL_ROOT/$MODEL_LARGE
PATH_MODEL_SMALL=$MODEL_ROOT/$MODEL_SMALL
PATH_MODEL_SMALL=/mnt/bn/bytenn-yg2/ycq/workspace/bytenn_diffusion_tools/results/NaivePrune/bk-sdm-tiny/ratio-0.75/checkpoint-50000
...
STEP_LIST=("5,20" "20,5" "10,15" "15,10")
