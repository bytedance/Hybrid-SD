...
MODEL_SMALL=lcm_sd14_ours_224_tiny_teacher
#MODEL_SMALL=ours-tiny224_LCM
...
PATH_MODEL_SMALL=results/lcm_sd14_ours_224_tiny_teacher
...
generate() {
    ...
    echo "OUTPUT_DIR=$3"
    echo "STPES=$4"
    CUDA_VISIBLE_DEVICES=$GPU_NUM python3 examples/hybrid_sd/hybrid_batch_latents.py \
            --model_id $1 $2\
            --output_dir $3 \
            --steps $4  \
...
do
    export OUTPUT_DIR=results/HybridSD_LCM_guidance7_edge_VAE/$MODEL_LARGE-$MODEL_SMALL-$STEP
