...
PATH_MODEL_LARGE=$MODEL_ROOT/$TEACHER_MODEL
...
generate() {
    ...
    CUDA_VISIBLE_DEVICES=$GPU_NUM python3 examples/hybrid_sd/hybrid_batch.py \
            ...
            --output_dir $3 \
            --steps $4  \
            --pretrained_teacher_model $PATH_MODEL_LARGE \
...
do
    export OUTPUT_DIR=results/HybridSDXL_guidance7/$MODEL_LARGE-$MODEL_SMALL-$STEP
