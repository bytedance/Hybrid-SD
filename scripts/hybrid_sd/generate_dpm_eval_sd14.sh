...
do
    ...
    #OUTPUT_DIR=/mnt/bn/bytenn-yg2/ycq/workspace/bytenn_diffusion_tools/results/HybridSD_dpm_guidance7/CompVis--stable-diffusion-v1-4-nota-ai--bk-sdm-small-25,0
    OUTPUT_DIR=/mnt/bn/bytenn-yg2/liuhj/hybrid_sd/bytenn_diffusion_tools/results/HybridSD_dpm_guidance7_fuxian_generate
