...
from compression.hybrid_sd.inference_pipeline import  HybridLCMInferencePipeline
...
if __name__ == "__main__":
    ...
    for index, model in enumerate(args.model_id):
        ...
        if "checkpoint" in model_name:
            model_arch = model.split("/")[-2]
            #model_config = model.split("/")[-2]
            #model_name = f'{model_arch}--{model_config}'
            model_name = f'{model_arch}'
