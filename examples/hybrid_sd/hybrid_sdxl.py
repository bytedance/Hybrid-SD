...
from compression.hybrid_sd.inference_pipeline import HybridSDXLInferencePipeline
...
def parse_args():
    ...
    parser.add_argument("--weight_dtype",type=str, default="fp32", help="weight dtype of the pipeline")
