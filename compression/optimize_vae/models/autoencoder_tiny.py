...
from diffusers.models.autoencoders.vae import DecoderOutput, DecoderTiny, EncoderTiny
...
class AutoencoderTinyWS(ModelMixin, ConfigMixin):
    r"""
    TinyVAE without scaling
    """
