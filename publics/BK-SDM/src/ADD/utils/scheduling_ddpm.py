...
class DDPMScheduler(SchedulerMixin, ConfigMixin):
    ...
    def get_z0(
        ...
        while len(sqrt_one_minus_alpha_prod.shape) < len(noisy_samples.shape):
            sqrt_one_minus_alpha_prod = sqrt_one_minus_alpha_prod.unsqueeze(-1)
        # print(f"noisy_samples.shape={noisy_samples.shape}, sqrt_one_minus_alpha_prod.shape={sqrt_one_minus_alpha_prod.shape}, noise.shape={noise.shape}, sqrt_alpha_prod.shape={sqrt_alpha_prod.shape}")
