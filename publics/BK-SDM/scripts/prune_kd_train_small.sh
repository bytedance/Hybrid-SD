...
MODEL_NAME="/mnt/bn/bytenn-yg2/pretrained_models/nota-ai--bk-sdm-small"
TRAIN_DATA_DIR="/mnt/bn/bytenn-yg2/datasets/laion_aes/preprocessed_212k" # please adjust it if needed

UNET_NAME="bk_small" # option: ["bk_base", "bk_small", "bk_tiny"]
OUTPUT_DIR="./results/bs64_prune_kd_"$UNET_NAME # please adjust it if needed
...
CUDA_VISIBLE_DEVICES=2 accelerate launch publics/BK-SDM/src/kd_train_t2i_prune_iteratively.py \
